...
public class InventoryTester : MonoBehaviour
{
    ...
    {
        if (inventory.AddItem(item1, 10) && inventory.AddItem(item2, 99) && inventory.AddItem(item2, 80) && inventory.AddItem(item3, 0) && inventory.AddItem(item4, 34) && inventory.AddItem(item5, 10))
        {
